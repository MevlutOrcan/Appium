...
//5-Bağlantı için çalışan Mobil hareketleri doğrulayın (uzun basın) ve WebView'a gidin
        ...
        MobileElement termConditions = driver.findElementByXPath("//android.widget.TextView[@text='Please read our terms of conditions']");
        TouchAction action = new TouchAction<>(driver);
        action.longPress(LongPressOptions.longPressOptions().withElement(ElementOption.element(termConditions))).perform();

        MobileElement closeButton = driver.findElementByXPath("//android.widget.Button[@text='CLOSE']");
